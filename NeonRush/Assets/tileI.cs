...
public class tileI
{
    ...
    private Vector3 localL4pos = new Vector3( 0.0f, 0.0f, 3.0f);

    // Attach y powerUp pos
    private Vector3 localLeftAttachPointpos = new Vector3(-1.0f, 0.0f, 3.0f);
    private Vector3 localForwardAttachPointpos = new Vector3( 0.0f, 0.0f, 4.0f);
    private Vector3 localForward2AttachPointpos = new Vector3( 0.0f, 0.0f, 4.0f);       // No lo pongo a la derecha que si salen pa la izquierda rip
    private Vector3 localLeftTopAttachPointpos = new Vector3(-1.0f, 1.0f, 3.0f);
    private Vector3 localForwardTopAttachPointpos = new Vector3( 0.0f, 1.0f, 4.0f);
    private Vector3 localForwardTop2AttachPointpos = new Vector3( 0.0f, 1.0f, 4.0f);
    ...
    //
    public Vector3 triggerSize = new Vector3(1.0f,0.1f,4.0f);
    public Vector3 triggerCenter = new Vector3(0.0f, 0.55f,1.5f);
