...
public class tileS
{
    ...
    private Vector3 localL3pos = new Vector3( -1.0f, 0.0f, 1.0f);
    ...
    private Vector3 localForward2AttachPointpos = new Vector3(-1.0f, 0.0f, 3.0f);       // No lo pongo a la derecha que si salen pa la izquierda rip
    ...
    private Vector3 localPowerUpPointpos = new Vector3(0.0f, 0.6f, 0.1f);
    ...
    public Vector3 triggerCenter = new Vector3(-0.5f, 0.55f, 1f);
